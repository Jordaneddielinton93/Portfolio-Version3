  ...
  return ( 
    <BrokenBorderStyled>
      <main className="divContainer">
        <SingleDivStyled/>
        <SingleDivStyled left={"25%"} top={scrollPosition/150>1.6 && (scrollPosition/150)<4?(scrollPosition/6):0}/>
        <SingleDivStyled left={"50%"} top={scrollPosition/150>1.6 && (scrollPosition/150)<4?(-scrollPosition/3):0}/>
